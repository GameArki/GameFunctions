...
namespace GameFunctions {
    ...
    public class GFEnumToggleButtonAttribute : Attribute {
        ...
        public GFEnumToggleButtonAttribute(string label) {
            this.label = label;
            belongField = null;
            buttonWidth = 105;
            buttonHeight = 30;
        ...
        public GFEnumToggleButtonAttribute(string label,int buttonWidth,int buttonHeight){
            this.label = label;
            belongField = null;
