...
namespace GameFunctions.Tests {
    ...
    public class BufferIOExtraSampleTest {
        ...
        public void TestRun() {
            ...
            // ==== Write ====
            MyExtraModel myModel = new MyExtraModel();
            ...
            myModel.herModel = new HerExtraModel() { name = "yo", value = 3 };
            myModel.herModelArr = new HerExtraModel[2] {
                new HerExtraModel{ name ="ho112", value = 4},
                new HerExtraModel{ value = -99}
            };
            myModel.herModelList = new List<HerExtraModel>() {
                new HerExtraModel{ name ="ho112", value = 4},
                new HerExtraModel{ value = -99}
            };
            ...
            // ==== Read ====
            MyExtraModel newModel = new MyExtraModel();
            offset = 0;
