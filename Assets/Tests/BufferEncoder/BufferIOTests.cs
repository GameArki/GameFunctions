...
namespace GameFunctions.Tests {
    ...
    public class BufferIOTests {
        ...
        public void Test_Fixed() {
            ...
            GFBufferEncoderWriter.WriteVector2(dst, new Vector2(1, 2), ref writeOffset);
            Vector2 vector2 = GFBufferEncoderReader.ReadVector2(dst, ref readOffset);
            Assert.That(vector2.x, Is.EqualTo(1));
            Assert.That(vector2.y, Is.EqualTo(2));

            GFBufferEncoderWriter.WriteVector3(dst, new Vector3(1, 2, 3), ref writeOffset);
            Vector3 vector3 = GFBufferEncoderReader.ReadVector3(dst, ref readOffset);
            Assert.That(vector3.x, Is.EqualTo(1));
            Assert.That(vector3.y, Is.EqualTo(2));
            Assert.That(vector3.z, Is.EqualTo(3));

            GFBufferEncoderWriter.WriteVector4(dst, new Vector4(1, 2, 3, 4), ref writeOffset);
            Vector4 vector4 = GFBufferEncoderReader.ReadVector4(dst, ref readOffset);
            ...
            GFBufferEncoderWriter.WriteQuaternion(dst, new Quaternion(1, 2, 3, 4), ref writeOffset);
            Quaternion quaternion = GFBufferEncoderReader.ReadQuaternion(dst, ref readOffset);
            ...
            GFBufferEncoderWriter.WriteColor(dst, new Color(1, 2, 3, 4), ref writeOffset);
            Color color = GFBufferEncoderReader.ReadColor(dst, ref readOffset);
            ...
            GFBufferEncoderWriter.WriteColor32(dst, new Color32(1, 2, 3, 4), ref writeOffset);
            Color32 color32 = GFBufferEncoderReader.ReadColor32(dst, ref readOffset);
            ...
            GFBufferEncoderWriter.WriteRect(dst, new Rect(1, 2, 3, 4), ref writeOffset);
            Rect rect = GFBufferEncoderReader.ReadRect(dst, ref readOffset);
            ...
            writeOffset = 0;
            readOffset = 0;
            GFBufferEncoderWriter.WriteMessage(newDst, new HerModel() { name = "Ho1", value = 1 }, ref writeOffset);
