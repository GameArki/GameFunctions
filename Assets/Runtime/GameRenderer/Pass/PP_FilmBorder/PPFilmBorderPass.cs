...
namespace GameRenderer {
    ...
    [Serializable]
    public class PPFilmBorderPass : ScriptableRenderPass {
...
#if UNITY_EDITOR
            if (shader == null) {
                shader = Shader.Find("NJM/Shader_PP_FilmBorder");
            }
#endif
            renderPassEvent = RenderPassEvent.BeforeRenderingPostProcessing;
            if (material == null) {
                material = CoreUtils.CreateEngineMaterial(shader);
                renderTag = "PP_FilmBorder";
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
            ...
            var volume = stack.GetComponent<PPFilmBorderVolume>();
            ...
            material.SetFloat("_BorderSize", volume.borderOffset.value.x * 0.5f); 
