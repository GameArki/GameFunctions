...
namespace GameArki.AddressableHelper {
    ...
    public static class GFAddressableHelper {
        ...
        /// </summary>
        public static void SetAddressables(UObject[] assets) {
        ...
        /// </summary>
        public static void SetAddressables(UObject[] assets, string addressableLableName) {
        ...
        /// </summary>
        public static void SetAddressables(UObject[] assets, string addressableLableName = null, string addressableGroupName = null, bool isSetSimplifiedName = false) {
        ...
        /// </summary>
        public static void SetAddressable(UObject asset) {
        ...
        /// </summary>
        public static void SetAddressable(UObject asset, string addressableLableName) {
        ...
        /// </summary>
        public static void SetAddressable(UObject asset, string addressableLableName = null, string addressableGroupName = null) {
            AddressableReflection(
                out var Settings_obj, out var groups_obj, out var DefaultGroup_prop, out var DefaultGroup_obj,
                out var CreateOrMoveEntry_met, out var GatherTargetInfos_met, out var SetAaEntry_met
            );
        ...
        /// </summary>
        public static void SetSimplifiedNames(UObject[] assets) {
            AddressableReflection(
                out var Settings_obj, out var groups_obj, out var DefaultGroup_prop, out var DefaultGroup_obj,
                out var CreateOrMoveEntry_met, out var GatherTargetInfos_met, out var SetAaEntry_met
            );
        ...
        /// </summary>
        public static void SetSimplifiedName(UObject asset) {
            AddressableReflection(
                out var Settings_obj, out var groups_obj, out var DefaultGroup_prop, out var DefaultGroup_obj,
                out var CreateOrMoveEntry_met, out var GatherTargetInfos_met, out var SetAaEntry_met
            );
        ...
        /// </summary>
        public static void SetLables(UObject[] assets, string lableName) {
            AddressableReflection(
                out var Settings_obj, out var groups_obj, out var DefaultGroup_prop, out var DefaultGroup_obj,
                out var CreateOrMoveEntry_met, out var GatherTargetInfos_met, out var SetAaEntry_met
            );
        ...
        /// </summary>
        public static void SetLable(string lableName, UObject asset) {
            AddressableReflection(
                out var Settings_obj, out var groups_obj, out var DefaultGroup_prop, out var DefaultGroup_obj,
                out var CreateOrMoveEntry_met, out var GatherTargetInfos_met, out var SetAaEntry_met
            );
        ...
        /// </summary>
        public static void SetGroups(UObject[] assets, string groupName) {
            AddressableReflection(
                out var Settings_obj, out var groups_obj, out var DefaultGroup_prop, out var DefaultGroup_obj,
                out var CreateOrMoveEntry_met, out var GatherTargetInfos_met, out var SetAaEntry_met
            );
        ...
        /// </summary>
        public static void SetGroup(UObject asset, string groupName) {
            AddressableReflection(
                out var Settings_obj, out var groups_obj, out var DefaultGroup_prop, out var DefaultGroup_obj,
                out var CreateOrMoveEntry_met, out var GatherTargetInfos_met, out var SetAaEntry_met
            );
        ...
        static void SetLables(string aaLableName, UObject[] aaAssetArray, object Settings_obj, object targetGroup_obj, MethodInfo method_CreateOrMoveEntry) {
        ...
        static void SetSimplifiedNames(UObject[] aaAssetArray, object Settings_obj, object targetGroup_obj, MethodInfo method_CreateOrMoveEntry) {
            var len = aaAssetArray.Length;
            for (int i = 0; i < len; i++) {
                var asset = aaAssetArray[i];
        ...
        static void SetLable(string aaLableName, UObject asset, object Settings_obj, object targetGroup_obj, MethodInfo method_CreateOrMoveEntry) {
            if (asset == null) {
        ...
        static void SetSimplifiedName(UObject asset, object Settings_obj, object targetGroup_obj, MethodInfo method_CreateOrMoveEntry) {
            if (asset == null) {
                Debug.LogWarning($"AA包资源为空!");
                return;
            }
